...
/**
 *    объявляем основные массивы:
 * 1)список отделов,
 * 2)список счастливчиков,
 * 3)список несчастливчиков,
 * 4)количество сотрудников в отделах,
 * 5)суммарный возраст по отделам,
 * 6)сумма зарплаты по отделам,
 * 7)максимальная зарплата в каждом отделе,
 * 8)минимальная зарплата в каждом отделе
 */
$departments = [];

$luckyPerson = [0 => [], 1 => [], 2 => [], 3 => [], 4 => []];
$unLuckyPerson = [0 => [], 1 => [], 2 => [], 3 => [], 4 => []];
...
if ($handle) {
    /**
     * создаем вспомогательный двумерный массив и помещаем в него данные из файла,
...
fclose($handle);
/**
 * Выводим по отделам статистику отдела
 */
